...
おすすめポイント:ドメイン駆動設計に関して初学者に分かりやすい説明に重点を置きつつ体系的にまとめている一冊。全編をC#のサンプルコードで説明しているがオブジェクト指向言語への知識があれば問題なく理解できる。各章ごとに関連する章を明記しており、各要素が互いに意味を与えあうドメイン駆動の設計思想理解の助けになる。

...
//imagetalkl[mai_nutoral]{
さっきはモックによって分業が可能になるって言ったけど、これは「画面とロジックの分離性の向上」にもつながるね。画面側をつくるフロントエンジニアもAPIができる前からモックを利用して画面のデータを用意することができるし、ほしいデータが足りないならどのバックエンドエンジニアに相談すればいいかも分かりやすい。
//}
